...
# Initialize coordinates and movement increments
LONDON_COORDINATES = {'latitude': 51.5074, 'longitude': -0.1278}
BIRMINGHAM_COORDINATES = {'latitude': 52.4862, 'longitude': -1.8904}

# Calculate movement increments to simulate vehicle movement
...
# Get the next simulated timestamp
def get_next_time():
    global start_time
...
# Generate random traffic camera data
...
# Generate random emergency incident data
...
# Simulate vehicle movement with randomness
...
# Simulate the journey and produce data to Kafka
